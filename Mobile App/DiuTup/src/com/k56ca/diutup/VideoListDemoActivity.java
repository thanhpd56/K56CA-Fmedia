 ...
 */
@TargetApi(13)
public final class VideoListDemoActivity extends Activity implements
	...
	public static final class VideoListFragment extends ListFragment {
		...
		static {
			...
			list.add(new VideoEntry("YouTube Collection", "ucHtu5XQ0WY", "0:21"));
			list.add(new VideoEntry("GMail Tap", "1KhZKNZO8mQ", "0:02"));
			list.add(new VideoEntry("Chrome Multitask", "UiLSiqyDf4Y", "9:10"));
			list.add(new VideoEntry("Google Fiber", "re0VRK6ouwI", "8:24"));
			list.add(new VideoEntry("Autocompleter", "blB_X38YSxQ", "16:27"));
			list.add(new VideoEntry("GMail Motion", "Bu927_ul_X0", "5:25"));
	...
	private static final class VideoEntry {
		...
		public VideoEntry(String text, String videoId, String duration) {
			this.text = text;
			this.videoId = videoId;
